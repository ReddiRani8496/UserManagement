...
import com.example.demo.repository.OurUsersRepository;
...
public class UserManagementService {
    ...
    public ReqRes register(ReqRes registrationRequest){
        ...
        try {
            ...
            if (!Objects.equals(ourUsersResult.getId(), "")) {
    ...
    public ReqRes login(ReqRes loginRequest){
        ...
        try {
            ...
            var user = ourUsersRepository.findByEmail(loginRequest.getEmail()).orElseThrow();
    ...
    public ReqRes getUsersById(String id) {
        ReqRes reqRes = new ReqRes();
        try {
            OurUsers usersById = ourUsersRepository.findById(id).orElseThrow(() -> new RuntimeException("User Not found"));
    ...
    public ReqRes updateUser(String userId, OurUsers updatedUser) {
    ReqRes reqRes = new ReqRes();
        try {
        Optional<OurUsers> userOptional = ourUsersRepository.findById(userId);
        if (userOptional.isPresent()) {
